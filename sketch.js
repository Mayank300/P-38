...
function setup() {
  createCanvas(displayWidth , displayHeight-550);
...
function draw() {
  ...
  textSize(70);
  fill("white");
  text("SCORE: "+ score, camera.position.x+20,camera.position.y-180);
  fill("brown");
  text("TIMER: "+timer, camera.position.x+520, camera.position.y-180);
}                        
